#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/usr/local/bin/configureStrelkaGermlineWorkflow.py --bam test.recal.cram --referenceFasta genome.fasta --callRegions chr22_1-40001.bed.gz --runDir strelka'
#
...
sys.path.append(r'/usr/local/share/strelka-2.9.10-1/lib/python')
...
main(r"/home/simon/Uni/Arbeit/sarek/work/0a/9a77a427621447a81c5796eb289ebf/strelka/runWorkflow.py.config.pickle","StrelkaGermline",StrelkaGermlineWorkflow)
